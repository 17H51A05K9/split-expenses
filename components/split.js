            ...
            <Container className="flex items-center justify-center gap-8">
                <section class="bg-white dark:bg-gray-900 rounded-lg">
                    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                        <h2 class="mb-4 md:text-xl sm:text-xs font-bold text-gray-900 dark:text-white">Add a new option for PaidBy field</h2>
                ...
                <div>
                    <button className="rounded-lg bg-yellow-600 max-w-48 md:w-40 sm:w-16 h-40 shadow-lg shadow-yellow-500/50 md:text-6xl sm:text-xl"><h3 className="md:text-xl sm:text-sm">Total Expenses</h3>{total}</button>
                </div>
                <section class="bg-white dark:bg-gray-900 rounded-lg">
                    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                        <h2 class="mb-4 md:text-xl sm:text-xs font-bold text-gray-900 dark:text-white">Add a new product</h2>
